BASE_DIR='~/Desktop/research/IDC_regular_ps50_idx5/'; % location of the input files.
NEW_BASE_DIR='~/PycharmProjects/IDC_full_train/resize/'; %where we'll put our modified patches
